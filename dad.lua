            ...
            function Dropdown:SetOpen(Bool)
                ...
                if Dropdown.IsOpen then 
                    ...
                    RenderStepped = RunService.RenderStepped:Connect(function()
                        ...
                        Items["OptionHolder"].Instance.Size = UDim2New(0, Items["RealDropdown"].Instance.AbsoluteSize.X, 0, Height)
    ...
    Library.Window = function(self, Data)
        ...
        local Items = Components:Window({
            ...
            task.spawn(function()
                ...
                if Ok and Content and Items["Avatar"] and Items["Avatar"].Instance then
        ...
        function Window:SetOpen(Bool, Instant)
            ...
            Window.IsOpen = Bool
            Library.WindowOpenState = Bool == true
            ...
            for Index, Value in Descendants do 
                ...
                if type(TransparencyProperty) == "table" then 
                    for _, Property in TransparencyProperty do 
                        if Value == LogoInst and Property == "ImageTransparency" then
                            continue
                        end
                        NewTween = Tween:FadeItem(Value, Property, Bool, Library.FadeSpeed)
                    end
                else
                    if Value == LogoInst and TransparencyProperty == "ImageTransparency" then
                        continue
                    end
                    NewTween = Tween:FadeItem(Value, TransparencyProperty, Bool, Library.FadeSpeed)
                end
